...
<?php if($banner){
 ...
 <section class="breadcrum-us-section top-space-subpage bottom-space" style="background-image: url('<?= $url?>');">
     ...
     <div class="breadcrum-content">
         <h1 class="title-breadcrum"> Indoor Activity </h1>
         <p class="breadcrum-sub-text mt-2 mb-0">
             Indoor activities encourage creativity and collaboration, offering students opportunities to engage in games, arts, and educational projects. These activities foster teamwork and help develop critical thinking skills in a comfortable environment.
         </p>
     </div>
 </section>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="imageModalLabel">Indoor Activity</h5>
