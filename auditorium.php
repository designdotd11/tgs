...
<?php if($banner){
 ...
 <section class="breadcrum-us-section top-space-subpage bottom-space" style="background-image: url('<?= $url?>');">
     ...
     <div class="breadcrum-content">
         <h1 class="title-breadcrum">  Auditorium </h1>
         <p class="breadcrum-sub-text mt-2 mb-0">
          The auditorium at TGS is a state-of-the-art facility designed for hosting assemblies, performances, and special events. It provides students with a platform to showcase their talents and participate in large-scale activities.
         </p>
     </div>
 </section>
