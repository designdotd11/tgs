...
<?php $this->load->view('web/include/testing-header')?>
...
.video-section video{ width:100%; height:100vh; object-fit:cover; }
...
@media (max-width:600px){
  ...
  .padding-for-small-screen-for-facilites {
      padding: 40px 36px;
  }
  .video-big-screen-div {
      display: none;
  }
  .video-small-screen-div {
      display: block;
  }
  .extra-padding-for-achivment-in-mobile {
      padding-top: 110px;
  }
  .swiperBtn-condition-for-screen {
      display: block;
  }
  ...
  .video-section {
      width: 100%;
      aspect-ratio: 4 / 3;  /* This keeps 4:3 ratio */
      position: relative;
      height:60vh;
  }
  ...
  .video-section video {
      width: 100%;
      height: 100%;
      object-fit: cover; /* Optional, keeps video inside frame */
      display: block;
  }
}
                         ...
                         <div class="swiper-wrapper">
                            ...
                            <div class="video-section position-relative overflow-hidden">
                                <div class="overlay_video">
                                    <div class="video-big-screen-div" style="height: 150vh;">
                                        <video autoplay muted loop playsinline class="img-fluid video-for-big-screen" style="height:150vh">
                                    ...
                                    <div class="video-small-screen-div" style="height: 70vh;">
                                        <video autoplay muted loop playsinline class="img-fluid video-for-small-screen" style="height:70vh">
                                            <source src="<?= base_url('assets/web')?>/videos/Good Shepherd's WT.mp4" type="video/mp4">
                                            <source src="<?= base_url('assets/web')?>/videos/Good Shepherd's WT.webm" type="video/webm">
                                            <source src="<?= base_url('assets/web')?>/videos/Good Shepherd's WT.ogv" type="video/ogv">
                                ...
                                <div class="video-content-parent">
                                   ...
                                   <div class="form width-right float-end p-0 hero-form-section" style="width: 454px;">
                                      <div>
                                        <?php
                                          $year = date('Y');
                                          $nextYear = $year + 1;
                                        ?>
                                        <h3 class="form-title text-end" style="margin-bottom: 5px; font-size:15px; font-weight:500">
                                          ADMISSION ENQUIRY: <?= $year ?>-<?= $nextYear ?>
                                          <!--<span class="d-block d-lg-inline session_add">SESSION : <?= $year ?>-<?= $nextYear ?></span>-->
                                        </h3>

                                    
                                        <div class="admission-form" style="border: 6px solid #009bbf; background: rgba(255,255,255,0.9); padding: 20px;">
                                          <!-- STEP 1: BASIC FORM -->
                                            ...
                                            <div class="row" id="step1" style="gap:6px;">
                                              <div class="col-12">
                                                <select id="session" name="session" required
                                                  ...
                                                  style="height:38px; font-size:16px; background-color:#009bbf; color:white; border:1px solid #ccc; border-radius:5px; padding:6px 10px;"
                                              ...
                                              <div class="col-12">
                                                <input type="text" name="student_name" id="studentName" required
                                                  ...
                                                  style="height: 26px; font-size: 16px; background-color:#009bbf; color:white;">
                                              </div>
                                              ...
                                              <div class="col-12 d-flex gap-1">
                                                <input type="text" value="+91" readonly
                                                  ...
                                                  style="width:25%; height:26px; font-size:16px; background-color:#009bbf; color:white;">
                                                <input type="tel" id="phone2" name="phone" required
                                                  pattern="[0-9]{10}" maxlength="10"
                                                  oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10);"
                                                  class="form-control border-0 rounded-0"
                                                  placeholder="Phone Number"
                                                  style="flex:1; height:26px; font-size:16px; background-color:#009bbf; color:white;">
                            
                                              </div>
                                        
                                              <div class="col-12 mt-2">
                                                <button type="button" id="sendOtpBtn" class="btn w-100 text-white"
                                                  style="background:#5e1914; font-weight:bold; font-size:16px; border-radius:100px;padding:10px;">
                                                  SEND OTP
                                                </button>
                                              </div>
                                            </div>
                                            ...
                                            <div class="row" id="step2" style="display:none; text-align:center; gap:6px;">
                                              ...
                                              <div class="col-12 mt-2">
                                                <button type="button" id="verifyOtpBtn" class="btn w-100 text-white"
                                                  style="background:#5e1914; font-size:16px; border-radius:100px;padding:10px;">
                                                  VERIFY OTP
                                                </button>
                                              </div>
                                            </div>
                                              ...
                                              <div class="col-12" style="margin-top:6px;">
                                                <div class="d-flex align-items-center gap-2">
                                                  ...
                                                  <input type="text" name="captcha" id="captcha-input-1" class="form-control rounded-0 captcha-input"
                                                         ...
                                                         style="height:26px; font-size:16px; background-color:#009bbf; color:white; flex:1; padding:6px 8px;">
...
<!-- Mobile Admission Enquiry Form -->
<div class="container-fluid bg-secondary text-white d-block d-md-none" style="padding-top:35px!important; padding-bottom:35px!important;">
  <div class="row justify-content-center">
    <div class="col-12" style="padding-left:30px; padding-right:30px;">
      ...
      <h3 class="text-end mb-2" style="font-size:15px; font-weight:500;">
        ADMISSION ENQUIRY: <?= $year ?>-<?= $nextYear ?>
      </h3>

      <div class="admission-form-mobile p-3" style="border:6px solid #009bbf; background:rgba(255,255,255,0.9);">
        <form id="enquiryForm" method="POST" action="<?= base_url('save_enquiry_ajax') ?>">
          ...
          <div id="step1" class="row g-2" >
            <div class="col-12">
              <select name="session" required class="form-select"
                style="height:38px; font-size:16px; background-color:#009bbf; color:white;"
                onchange="this.style.backgroundColor=this.value?'#fff':'#009bbf';this.style.color=this.value?'#000':'#fff';">
                <option value="">Select Session *</option>
                <option value="2025-26">2025-26</option>
                <option value="2026-27">2026-27</option>
            ...
            <div class="col-12">
              <input type="text" name="fathers_name" required class="form-control"
                placeholder="Father's Name *"
                style="height:26px; font-size:16px; background-color:#009bbf; color:white;">
            </div>

            <div class="col-12 d-flex gap-2">
              <input type="text" value="+91" readonly class="form-control text-center"
                style="width:25%; height:26px; font-size:16px; background-color:#009bbf; color:white;">
              <input type="tel" name="phone" id="phone2" required pattern="[0-9]{10}" maxlength="10"
                oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,10);"
          ...
          <!-- STEP 2: OTP -->
          <div id="step2" class="row g-2 text-center" style="display:none;">
            <div class="col-12 d-flex justify-content-center gap-2">
              <input type="text" maxlength="1" class="form-control text-center otp-box" style="width:40px; color:black;">
              <input type="text" maxlength="1" class="form-control text-center otp-box" style="width:40px; color:black;">
              <input type="text" maxlength="1" class="form-control text-center otp-box" style="width:40px; color:black;">
              <input type="text" maxlength="1" class="form-control text-center otp-box" style="width:40px; color:black;">
            </div>
          ...
          <!-- STEP 3: FULL FORM -->
          <div id="step3" class="row g-2 mt-2" style="display:none;">
            <div class="col-12">
            ...
            <div class="col-12 d-flex gap-2">
              ...
              <select name="school" required class="form-select"
                style="height:26px; font-size:16px; background-color:#009bbf; color:white;">
                <option value="">Select School</option>
                <option value="St. Thomas School">St. Thomas School</option>
                <option value="The Trinity School">The Trinity School</option>
            ...
            <div class="col-12">
              <select name="student_class" required class="form-select"
                style="height:26px; font-size:16px; background-color:#009bbf; color:white;">
                <option value="">Select Class *</option>
                <option value="M1 (Pre-Nursery)">M1 (Pre-Nursery)</option>
                <option value="M2 (LKG)">M2 (LKG)</option>
            ...
            <div class="col-12">
              <select name="referal" required class="form-select"
                style="height:26px; font-size:16px; background-color:#009bbf; color:white;">
                <option value="">How Did You Hear About Us? *</option>
                <option value="Website">Website</option>
                <option value="Group Website">Group Website</option>
            ...
            <div class="col-12">
              <div class="d-flex align-items-center gap-2">
                <input type="text" name="captcha" id="captcha-input-1" required class="form-control"
                  placeholder="Security"
                  style="height:26px; font-size:16px; background-color:#009bbf; color:white;">
                <span id="captcha-code-1" class="px-2 py-1 border rounded bg-light text-dark fw-bold"
                  style="height:26px; display:flex; align-items:center;">
                  <?= $captchacode ?>
                </span>
              </div>
              <div id="captcha-error-1" class="text-danger small mt-1"></div>
            </div>
                         ...
                         <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <div class="news-event-card position-relative"
                                 onclick="window.location.href='<?= base_url('news-details/') . $nw->slug ?>'"
                              ...
                              <div class="news-img" style="height:228px;">
                                <img src="<?= base_url('uploads/news/thumbnail/') . $nw->thumbnail ?>"
                                     class="img-fluid"
                                     alt="<?= $nw->title ?>"
                              ...
                              <div class="news-content">
                                ...
                                <div class="read-more-1 text-decoration-none text-dark fw-bold">
                                  Read More <i class="fas fa-caret-right" style="color:#333;"></i>
                                </div>
                              </div>
                            </div>
                          </div>
