 ...
 <section class="breadcrum-us-section top-space-subpage bottom-space" style="background-image: url('<?= $url?>');">
     ...
     <div class="breadcrum-content">
         <h1 class="title-breadcrum"> Advisory Board</h1>
         <p class="breadcrum-sub-text mt-2 mb-0">
             Welcome to TGS School, where our advisory board member brings a rich blend of expertise, experience, and enthusiasm to foster 
         ...
         <div class="row">
             <div class="col-lg-3 col-md-6 mb-4">
                 <div class="team-member">
                     <div class="team-img">
                         <img src="<?= base_url('assets/web')?>/images/no-image.jpg" alt="N. Thomaskutty">
